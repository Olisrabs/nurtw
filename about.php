...
<head>
    <title>NURTW - About Us Page</title>
    <meta charset="utf-8">
...
<body data-mobile-nav-style="classic">
            ...
            <div class="container-fluid">
                <div class="col-auto col-xxl-3 col-lg-2 me-lg-0 me-auto">
                    <a class="" href="index.php">
                        <img src="images/nurtw-logo.jpg" alt="" style="width: 80px; height: 80px;"
                            class="default-logo mobile-logo">
                    </a>
                </div>
                        ...
                        <div class="d-none d-xxl-inline-block me-25px xxl-me-10px">
                            <div class="alt-font fs-15 xl-fs-13 widget-text fw-500">
                                <span
                                    ...
                                    <a href="main/member_login.php" class="widget-text text-white-hover "><i class="feather icon-feather-user me-10px"></i></a>
                                </span>
                            </div>
                        </div>
                    </div>
    ...
    <section class="page-title-big-typography bg-dark-gray ipad-top-space-margin" data-parallax-background-ratio="0.5"
        style="background-image: url(images/demo-business-about-title-bg.jpg)">
            ...
            <div class="row align-items-center justify-content-center extra-small-screen">
                <div class="col-12 position-relative text-center page-title-extra-large">
                    <h1 class="m-auto text-white text-shadow-double-large fw-500 ls-minus-3px xs-ls-minus-2px"
                        data-anime='{ "translateY":
                        [15, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        About <strong>NURTW</strong></h1>
                </div>
            ...
            <div class="row align-items-center justify-content-center">
                            ...
                            <div class="atropos-rotate">
                                <div class="atropos-inner">
                                    <div data-atropos-offset="3">
                                        <img src="images/demo-business-about-01.jpg" class="border-radius-6px w-100"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-5 col-lg-6 offset-lg-1 col-md-9 ps-6 text-center text-lg-start lg-ps-15px"
                    ...
                    <span
                        ...
                        NURTW</span>
                    <h3 class="fw-600 text-dark-gray ls-minus-2px alt-font sm-w-80 xs-w-100 mx-auto sm-mb-20px">The Voice of Road Transport Workers</h3>
                    <p>The <strong>National Union of Road Transport Workers (NURTW)</strong> is a nationwide trade union that represents drivers, riders, and transport workers across Nigeria. Established in 1978, the union is dedicated to organizing motor parks, improving road transport services, protecting workers’ rights, and promoting safety on Nigerian roads.</p>
                    <p>With a presence in all 36 states and the FCT, NURTW connects millions of people daily through safe and reliable road transport. Beyond transportation, the union supports members’ welfare, provides training, and contributes to community development, making it a vital part of Nigeria’s economy and social structure.</p>
                    <a href="demo-business-services.php"
                        class="btn btn-large btn-dark-gray btn-box-shadow btn-rounded mt-15px sm-mt-10px">Our services<i
                ...
                <div class="col-md-6 col-sm-8 md-mb-35px">
                    <div class="row align-items-center justify-content-center"
                        ...
                        <div class="col-auto"><span
                                class="alt-font text-dark-gray fw-600 fs-130 lg-fs-110 ls-minus-7px">30</span></div>
                        ...
                        <div class="col-3 col-xl-3 col-md-2 text-center d-none d-lg-inline-block"><span
                                class="fw-400 fs-110 text-base-color position-relative top-minus-10px">|</span></div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-3">
                <div class="col-xl-5 col-lg-6 col-sm-8 text-center"
                    ...
                    <span
                        class="bg-white text-uppercase fs-13 ps-25px pe-25px alt-font fw-600 text-base-color lh-40 sm-lh-55 border-radius-100px d-inline-block mb-25px">Process
                        cycle</span>
            ...
            <div class="row justify-content-center"
                ...
                <div class="col-lg-6 col-md-8 fancy-text-box-style-02 mb-30px">
                    <div
                        ...
                        <div
                            ...
                            <span class="text-dark-gray fw-500 fs-20 xs-fs-18 alt-font ls-minus-05px">Business
                                founded</span>
                ...
                <div class="col-lg-6 col-md-8 fancy-text-box-style-02 mb-30px">
                    <div
                        ...
                        <div
                            class="feature-box-content border-start border-color-extra-medium-gray ps-40px pe-40px lg-ps-15px lg-pe-15px last-paragraph-no-margin">
                            <span class="text-dark-gray fw-500 fs-20 xs-fs-18 alt-font ls-minus-05px">Build new
                                office</span>
                            <p class="text-light-opacity">Lorem ipsum dolor amet</p>
                        </div>
                        <div class="feature-box-overlay bg-base-color"></div>
                ...
                <div class="col-lg-6 col-md-8 fancy-text-box-style-02 md-mb-30px">
                    <div
                        ...
                        <div
                            class="feature-box-content border-start border-color-extra-medium-gray ps-40px pe-40px lg-ps-15px lg-pe-15px last-paragraph-no-margin">
                            <span class="text-dark-gray fw-500 fs-20 xs-fs-18 alt-font ls-minus-05px">Relocates
                                headquarter</span>
                            <p class="text-light-opacity">Lorem ipsum dolor amet</p>
                        </div>
                        <div class="feature-box-overlay bg-base-color"></div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-3">
                <div class="col-xl-5 col-lg-6 col-sm-8 text-center"
                    data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <span
                        class="bg-solitude-blue text-uppercase fs-13 ps-25px pe-25px alt-font fw-600 text-base-color lh-40 sm-lh-55 border-radius-100px d-inline-block mb-25px">Creative
                        team</span>
            ...
            <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 justify-content-center"
                ...
                <div class="col text-center team-style-05 md-mb-35px">
                    <div class="position-relative mb-30px last-paragraph-no-margin">
                        <img src="images/team-08.jpg" class="border-radius-4px" alt="">
                        <div
                            ...
                            <p class="text-white w-80 lg-w-75 sm-w-80 absolute-middle-center opacity-7">Lorem ipsum
                                simply of printing typesetting.</p>
                ...
                <div class="col text-center team-style-05 md-mb-35px">
                    <div class="position-relative mb-30px last-paragraph-no-margin">
                        <img src="images/team-09.jpg" class="border-radius-4px" alt="">
                        <div
                            class="w-100 h-100 d-flex flex-column justify-content-end align-items-center border-radius-4px p-40px team-content bg-base-color-transparent">
                            <p class="text-white w-80 lg-w-75 sm-w-80 absolute-middle-center opacity-7">Lorem ipsum
                                simply of printing typesetting.</p>
                ...
                <div class="col text-center team-style-05 xs-mb-35px">
                    <div class="position-relative mb-30px last-paragraph-no-margin">
                        <img src="images/team-10.jpg" class="border-radius-4px" alt="">
                        <div
                            class="w-100 h-100 d-flex flex-column justify-content-end align-items-center border-radius-4px p-40px team-content bg-base-color-transparent">
                            <p class="text-white w-80 lg-w-75 sm-w-80 absolute-middle-center opacity-7">Lorem ipsum
                                simply of printing typesetting.</p>
                ...
                <div class="col text-center team-style-05">
                    <div class="position-relative mb-30px last-paragraph-no-margin">
                        <img src="images/team-11.jpg" class="border-radius-4px" alt="">
                        <div
                            class="w-100 h-100 d-flex flex-column justify-content-end align-items-center border-radius-4px p-40px team-content bg-base-color-transparent">
                            <p class="text-white w-80 lg-w-75 sm-w-80 absolute-middle-center opacity-7">Lorem ipsum
                                simply of printing typesetting.</p>
    ...
    <section class="pt-0">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5 text-center mb-2 xs-mb-4"
                    data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <span
                        class="text-dark-gray fw-600 fs-16 text-uppercase border-1 pb-5px border-bottom border-color-extra-medium-gray text-dark-gray">Join
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div
                    ...
                    <a href="index.php" class="mb-15px d-block d-lg-inline-block"><img src="images/nurtw-logo.jpg"
                            style="width: 80px; height: 80px;" alt=""></a>
                    <p class="w-90 sm-w-100 d-inline-block mb-15px">Nigeria’s union for road transport workers since
                        1978.</p>
                    <p>&COPY;
                        <script>document.write(new Date().getFullYear())</script> <a href="index.php" target="_blank"
                            class="text-white text-decoration-line-bottom">NURTW</a>
                    </p>
                </div>
                <!-- end footer column -->
                <!-- start footer column -->
                <div class="col-5 col-lg-2 col-sm-4 md-mb-50px sm-mb-30px order-1 order-lg-2">
                    ...
                    <ul>
                        ...
                        <li><a href="main/member_register.php">Register as a member</a></li>
                        <li><a href="main/member_login.php">Login as a member</a></li>
                    </ul>
                </div>
                <!-- end footer column -->
                ...
                <div class="col-7 col-lg-3 col-sm-6 xs-mb-30px last-paragraph-no-margin order-4 order-sm-5 order-lg-5">
                    ...
                    <p class="w-80 lg-w-100 md-w-70 sm-w-100 mb-10px">8 Sapele Crescent, Garki 2, Abuja, Federal Capital
                        Territory, Nigeria</p>
                    <div><i class="feather icon-feather-phone-call icon-very-small text-white me-10px"></i><a
                            href="tel:12345678910" class="text-white">+234 803 304 1476</a></div>
                    <div><i class="feather icon-feather-mail icon-very-small text-white me-10px"></i><a
                            href="mailto:info@nurtw.com"
                            class="text-white text-decoration-line-bottom">info@nurtw.com</a></div>
                </div>
                <!-- end footer column -->
            </div>
        </div>
