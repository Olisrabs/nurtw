...
<html lang="zxx">
<head>
    <title>NURTW - Member Forget Password</title>
                    ...
                    <div class="form-info">
                        <div class="form-section align-self-center">
                            <div class="btn-section clearfix">
                                <a href="member_login.php" class="link-btn active btn-1 default-bg">Login</a>
                                <a href="index.php" class="link-btn btn-2 default-bg">Register</a>
                            </div>
                            <div class="logo">
                                <a href="../">
