...
<head>
    <title>NURTW - Admin Email Verification</title>
                                ...
                                <form method="post">
                                    <?php
                                        ...
                                        if (isset($_REQUEST["submit"])) {
                                            ...
                                            $check = mysqli_query($conn, "SELECT * FROM staff WHERE uin = '$uin' OR email = '$emailreg'");
                                            $checkrow = mysqli_num_rows($check);

                                            if ($checkrow > 0) {
                                                echo "<script>alert('User already exists!');</script>";
                                            } else {
                                                $query = "INSERT INTO staff (uin, email, otp, `status`) VALUES ('$uin', '$emailreg', '$otp', 'Pending')";
...
//                                     <p style='margin-bottom: 10px;'>Yoo, wassup?,</p>
//                                     <p style='margin-bottom: 10px;'>Your OTP to complete your registration on Olisrab is:</p>
...
// 	if ( $mail->send() ) {
                                                    ...
                                                    location.href = 'admin_otp.php?uin=$uin&email=$emailreg';</script>";
                                                }
                                            }
                                        }
                                        // }
