...
if (isset($_POST['identifier']) && isset($_POST['password'])) {
    ...
    if ($rows == 1) {
        ...
        if ($user['role'] == 'Super Admin') {
            ...
            echo "<script>alert('Unauthorized role. Please contact admin.'); location.href='admin_login.php';</script>";
        }
    } else {
        echo "<script>alert('Invalid login credentials.'); location.href='admin_login.php';</script>";
    }
}
?>
                    ...
                    <div class="form-info">
                        <div class="form-section align-self-center">
                            <div class="btn-section clearfix">
                                <a href="admin_login.php" class="link-btn active btn-1 active-bg default-bg">Login</a>
                                <a href="admin_index.php" class="link-btn btn-2">Register</a>
                            </div>
                            <div class="logo">
                                <a href="../">
                            ...
                            <form method="post">
                                ...
                                <div class="checkbox form-group clearfix">
                                    ...
                                    <a href="admin_forgot_password.php" class="float-end forgot-password">Forgot your password?</a>
                                </div>
                                <div class="form-group clearfix">
