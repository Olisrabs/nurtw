...
<head>
    ...
    <!-- TITLE -->
    <title>Staff Dashboard || NURTW </title>
            ...
            <div class="app-header header sticky">
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <!-- sidebar-toggle-->
                        <a class="logo-horizontal " href="admin_dashboard.php">
                                        ...
                                        <div class="dropdown  d-flex notifications">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                ...
                                                <div class="notifications-menu">
                                                    <a class="dropdown-item d-flex" href="admin_notify_list.php">
            ...
            <div class="sticky">
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="admin_dashboard.php">
                            <img src="assets/images/brand/logo-white.png" class="header-brand-img desktop-logo" alt="logo">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="admin_dashboard.php"><i
											...
											<div class="tab-content">
												<div class="tab-pane active" id="side9">
													<ul class="sidemenu-list">
                                                        ...
                                                        <li><a href="admin_profile.php" class="slide-item"> Profile</a></li>
                                                        <li><a href="admin_editprofile.php" class="slide-item"> Edit Profile</a></li>
                                                        <li><a href="admin_notify_list.php" class="slide-item"> Notifications List</a></li>
                                                        ...
                                                        <li class="sub-slide">
                                                            ...
                                                            <ul class="sub-slide-menu">
                                                                ...
                                                                <li><a href="admin_datatable.php" class="sub-slide-item"> Data Tables</a></li>
