...
<head>
    ...
    <!-- TITLE -->
    <title>NURTW - Non-verified Drivers</title>
...
<body class="app sidebar-mini ltr light-mode">
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Non-verified Drivers</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Drivers</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Non-verified Drivers</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
    ...
    <!-- INTERNAL Date-Time-Table JS -->
    <script src="assets/plugins/extension-datatable/date-time/moment.js"></script>
    <script src="assets/plugins/extension-datatable/date-time/dataTables.dateTime.min.js"></script>
    <script src="assets/js/datetime-table.js"></script>
